...
Titre de la publication: <br><input type="text" name="titre_admin" value="<?php echo $xt; ?>"/><br>
Votre publication: <br><textarea name="texte_admin"  cols="70" rows="20" id="mytextarea">
<?php echo $xb;?>
</textarea>
