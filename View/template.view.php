            ...
            <ul class="navbar-nav row col-sm-4">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <?php
                    ...
                    $titre_extrait= $Get_Extrait->extrait($posts_data->getTitle(), 4);
                    ?>
                      <a class="dropdown-item" href="index.php?action=montrer_chapitre&id=<?php echo $posts_data->getId()?>">
          ...
          <div class=" bloc-gauche isBCWhite">
            <div class="nav flex-column  isRound  container_chapitre">
              ...
              <div class=" d-flex justify-content-center align-content-center align-item-center column">
                ...
                foreach ($posts_datas as $posts_data) {
                    ?>
                  <a href="index.php?action=montrer_chapitre&id=<?php echo $posts_data->getId()?>" class="nav-link2">
                    <h3><?php echo $posts_data->getTitle()?></h3></a>
                    <form action='index.php?action=montrer_ecriture' method='POST'>
                      <input name="idk" type="hidden" value="<?php echo $posts_data->getId() ?>" />
                <?php  if (isset($_SESSION['admin'])) { ?>
                        <button name='supprimer_chapitre' value='supprimer'>Supprimer</button> <a href=index.php?action=modification&id_chapitre=<?php echo $posts_data->getId() ?> class="bouton">modifier</a></form>
                        <?php } else { ?>
                      </form>
                        <?php
                        }
        ...
        <div class="navig isRound isFade">
          <nav class="navbar navbar-expand-md navbar-light bg-light justify-content-around">
            <ul class="navbar-nav row col-sm-4">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <?php
                    $titre_extrait= $Get_Extrait->extrait($posts_datas->getTitle(), 4);
                    ?>
                      <a class="dropdown-item" href="index.php?action=montrer_chapitre&id=<?php echo $posts_datas->getId()?>">
                    <?php echo $titre_extrait.'[...]' ?>
                  </a>
              </div>
            </li>
